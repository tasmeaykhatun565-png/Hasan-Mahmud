...
const TIME_FRAMES = [
  '5s', '10s', '15s', '30s', '1m', '2m', '5m', '10m', '15m', '30m', '1h', '4h', '1d'
];
      ...
      <div className="pb-8 pt-2">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 px-4 mb-3">
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Candle Time Frame</h3>
        ...
        {/* Chart Type Section */}
        <div>
          <h3 className="px-4 text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Chart Type</h3>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    currentChartType === type.id
                      ? "bg-[#2a2e39] border-white/10 text-white"
